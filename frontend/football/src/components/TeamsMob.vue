<template>
  <div class="container-md" style="box-shadow: 0 0 5px 1px darkgray;">
    <div>
      <h5>Russian Premier League</h5>
      <SelectedMob v-model="modelValue" v-bind:options="options" @change="sorted_func"></SelectedMob>
    </div>
    <div class="card mb-3" style="max-width: 840px;" v-for="team in teams">
      <a href="#" @click="$router.push('/teams/club')" style="color: rgb(70,70,70); text-decoration: none;">
        <div class="row g-0">
          <div class="col-md-4"><img v-bind:src="require(`../assets/teams/${team.photo}`)" class="img-fluid img-thumbnail" alt="..."></div>
          <div class="col-md-8">
            <div class="card-body">
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">XG : {{team.xg}}</li>
...
<script>
import SelectedMob from "@/components/UI/SeletedMob";
export default {
  name: "TeamsMob",
  props:{
    teams:{
...
<style scoped>
  ...
  .card:active{
    box-shadow: 0 0 15px 1px rgb(140,140,140) inset;
    transition: 0.1s;
  }
  .img-thumbnail{
    border-radius: 50%;
