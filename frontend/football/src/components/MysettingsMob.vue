<template>
  <div class="container">
    ...
    <button type="button" class="btn btn-success btn-sm" v-on:click="me_update({image: this.files, first_name: this.field.first_name, last_name: this.field.last_name, email: this.field.email, username: this.field.username})"><fa icon="fa-solid fa-floppy-disk"></fa></button>
  </div>
</template>
